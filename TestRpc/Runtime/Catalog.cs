...
namespace TestRpc.Runtime
{
    ...
    {
        private readonly ConcurrentDictionary<ActivationId, Activation> activations = new ConcurrentDictionary<ActivationId, Activation>(ActivationIdEqualityComparer.Instance);
