...
namespace Hagar.Buffers
{
    public ref struct Reader
    {
        ...
        public Reader(ReadOnlySequence<byte> input, SerializerSession session)
        {
            ...
            //this.input.TryGet(ref this.nextSequencePosition, out var memory, advance: true);
        ...
        private void MoveNext()
        {
            ...
            if (ReferenceEquals(this.input.Start.GetObject(), this.nextSequencePosition.GetObject())) this.input.TryGet(ref this.nextSequencePosition, out _);
